# Unit test that generates DICOM images that can be used with HothXRay
1. Modify ImageExtractorUT\Program.cs to outline your path
2. Execute Main ImageExtractorUT\Program.cs
3. Drag and drop images into HothXRay project
